...
RCCL_ASSERT_OFFSET(rcclApiFuncTable, ncclPutSignal_fn, 43);
RCCL_ASSERT_OFFSET(rcclApiFuncTable, ncclSignal_fn, 44);
RCCL_ASSERT_OFFSET(rcclApiFuncTable, ncclWaitSignal_fn, 45);
